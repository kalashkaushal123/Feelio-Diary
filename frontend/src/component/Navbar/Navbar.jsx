  ...
  return (
    <div className="py-4 px-12 flex relative">
        ...
        <div className="flex absolute right-20 top-10 gap-4">
          <div className="flex bg-white px-6 py-2.5 rounded-3xl shadow-[0_0_30px_rgba(255,255,255,1)] text-purple-800"> <IoPersonOutline className="mt-1 mr-1.5"/> Login</div>
          <div className="flex bg-[#FF69B4] text-white px-6 py-2.5 rounded-3xl shadow-[0_0_30px_rgba(255,255,255,1)]"> <FaHeart className="mt-1 mr-1.5" /> Sign Up</div>
          <div className="bg-white px-3  rounded-full shadow-[0_0_30px_rgba(255,255,255,1)] text-purple-900"> <FaMoon className="mt-3 text-xl" /> </div>
        </div>
      </div>
  )
}
